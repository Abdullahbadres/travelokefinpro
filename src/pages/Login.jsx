  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.user.role === "admin" || localStorage.getItem("role") === "admin") {
          navigate("/admin")
        } else {
          navigate(from)
        }
      } else {
        // If login returned success: false but didn't throw an error
      ...
      <div className="max-w-md w-full space-y-8 bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-xl">
        <div>
          <div className="flex justify-center">
            <img src="https://i.ibb.co.com/ZpJKSvDB/traveloke-removebg-preview.png" alt="Traveloke Logo" className="h-16" />
          </div>
          <h2 className="mt-4 text-center text-3xl font-extrabold text-gray-900">Welcome Back</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Or{" "}
            <Link to="/register" className="font-medium text-[#FF7757] hover:text-[#ff6242]">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="#" className="font-medium text-[#FF7757] hover:text-[#ff6242]">
